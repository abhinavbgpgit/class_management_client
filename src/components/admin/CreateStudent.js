...
const CreateStudent = () => {
  ...
  const[data,setData]=useState([]) 
    ...
    const storeNewStudentData=()=>
        {     
        console.log(name,email,phoneNumber,address)
      axios.post("http://localhost:5000/createstudent",{name: name, email:email,phoneNumber:phoneNumber,address:address} )
...
return (
  ...
  >
 <div><h2 style={{color:"white",border:"2px dashed white", "border-radius":"10px"}}>Create New Student</h2></div>
 <ul className='create_class'>
  ...
  <button onClick={(e)=>{storeNewStudentData()}}>Create new student</button>
